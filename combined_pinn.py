...
class CompetingHybridEnv(gym.Env):
    ...
    def __init__(self, pinn_model, y_bus_tf, bus_data, v_base_lv, dqn_agent=None, num_evcs=5, num_buses=33, time_step=0.1, **physics_params):
    ...
    def step(self, action):
        ...
        try:
            ...
            done = self.time_step_counter >= 1000 or np.sum(self.voltage_deviations >= 0.4) >= self.target_evcs.sum()
